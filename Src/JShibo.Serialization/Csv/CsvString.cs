...
namespace JShibo.Serialization.Csv
{
    public class CsvString
    {
            ...
            foreach (object o in value)
            {
                if (o != null)
                {
                    if (o is ValueType)
                    {
                        ...
                        ShiboCsvStringSerializer.LoopSerialize(this, o);
                }
                else
                    WriteNullWithoutName();
            }
        ...
        {
            ResizeAndWriteName(10);
            ShiboCsvStringSerializer.LoopSerializeEnumerable(this, value);
        ...
        private void WriteObjectList(IList value)
        {
            ResizeAndWriteName(10);
            if (value.Count > 0)
                ShiboCsvStringSerializer.LoopSerializeObjectList(this, value);
            else
                WriteZeroArrayWithoutName();
        }
        ...
        private void WriteTList(IList value)
        {
            ...
            if (value.Count > 0)
            {
                ShiboCsvStringSerializer.LoopSerializeList(this, value);
            }
            else
                WriteZeroArrayWithoutName();
        }
        ...
        internal void Write(char[] value)
        {
            ...
            {
                ResizeAndWriteName(value.Length + SizeConsts.VALUETYPE_LEN);
                InternalWrite(value);
            }
        }
